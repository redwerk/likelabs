                                            ...
                                            <table cellpadding="0" cellspacing="0" summary="" class="form" style="width: 100%;">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="1" style="width: 100%; border: solid 1px #d2d9df" summary="" class="content_table field">
                                                            ...
                                                            <tr style="background-color: #fdfeff">
                                                                ...
                                                                <td>
                                                                    <a href="/company/1/point/add"><img src="/static/images/edit-icon.png" alt="Edit" title="Edit"/></a>
                                                                    <a href="javascript:void(0);"><img src="/static/images/delete.png" alt="Delete" title="Delete"/></a>
                                                                </td>
                                                            </tr>
                                                            <tr style="background-color: #efefef">
                                                                <td>Address2</td>
                                                    ...
                                                    <td style="text-align: center; vertical-align: top; padding-left: 40px; width: 260px;">
                                                        <div class="logo" style="margin-left: 7px;"><img src="http://lifehacker.ru/wp-content/uploads/2012/03/1229898047_mozilla_firefox.jpg" alt="" width="217"/></div>
