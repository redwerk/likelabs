...
+ (void)initialize
{
	if (self == [ASIHTTPRequest class]) {
		...
		ASIAuthenticationError = [[NSError alloc] initWithDomain:NetworkRequestErrorDomain code:ASIAuthenticationErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"Incorrect credentials",NSLocalizedDescriptionKey,nil]];
